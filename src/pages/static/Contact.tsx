          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <span className="opacity-75 mt-1"><Mail/></span>
                <div>
                  <p className="text-xs uppercase tracking-wider text-slate-200">Email</p>
                  <p className="font-medium text-green-600">{settings.support_email}</p>
                </div>
              </div>
              {/* <div className="flex items-start gap-4">
              ...
              <div className="flex items-start gap-4">
                <span className="opacity-75 mt-1"><MapPin/></span>
                <div>
                  <p className="text-xs uppercase tracking-wider text-slate-200">Location</p>
                  <p className="font-medium text-green-600">Lucknow, India</p>
                </div>
              </div>
            </div>
          </div>
